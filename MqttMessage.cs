...
namespace Microsoft.Azure.WebJobs.Extensions.MqttOutputBinding
{
    /// <summary>
    /// A MQTT message.
    /// </summary>
    public class MqttMessage : IMqttMessage
    {
        ...
        /// </summary>
        public MqttMessage(string topic, ArraySegment<byte> message, MqttQualityOfServiceLevel qosLevel, bool retain)
        {
            Topic = topic;
            Message = message;
            QosLevel = qosLevel;
